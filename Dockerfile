...
RUN sudo curl -sSfO https://download.build2.org/0.13.0/build2-install-0.13.0.sh && \
    sudo sh build2-install-0.13.0.sh --yes --trust yes && \
    sudo rm -rf build2-toolchain-0.13.0.tar.xz build2-toolchain-0.13 build2-install-0.13.0.sh
